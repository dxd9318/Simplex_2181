...
void Application::Display(void)
{
	...
	/*
	//->xyz order, 90 around y locks x&z
	//->yxz order, 90 around x locks y&z
	//rotating 90 on the hierarchical-middle axis locks the other two axes
	...
	*/
	...
	//m_qOrientation = m4OrientX * m4OrientY * m4OrientZ;
